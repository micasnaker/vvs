<!-- 商品列表 -->
<template>
  <div class="hot" v-if="hotsell.length>0">
      <div class="heade_wrap">
          <i><img src="../assets/images/home/hot2x.png" alt=""></i>
      </div>
      <div class="shopList">

      <div class="shop_wrap" v-for="(item, index) in hotsell" :key="index" @click="goDetail(item.id)">
          <div class="shop_img"><img :src="item.img" alt="" v-lazy="item.img"></div>
          ...
          <div class="print_wrap">
              <span>已售417件</span>
            <div class="img_buy"><img src="../assets/images/home/btn_buy.png" alt=""></div>
          </div>
      </div>
