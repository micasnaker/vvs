<!-- 商品列表 -->
<template>
  <div class="hot" v-if="recoms.length>0">
      <div class="heade_wrap">
          <i><img src="../assets/images/home/recom2x.png" alt=""></i>
      </div>
      <div class="shopList">

      <div class="shop_wrap" v-for="(item, index) in recoms" :key="index" @click="goDetail(item.id)">
