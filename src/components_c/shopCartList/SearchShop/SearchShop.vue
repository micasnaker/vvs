...
<template>
  <!-- <div>
    ...
    <div class="shop">
      ...
      <div class="shop_wrap">
          <div class="shop_img"><img src="../../../assets/images/search/shop@2x.png" alt=""></div>
          <div class="title_wrap">
              <p>粒大饱满，美味健康</p>
          </div>
          <span class="shop_name">碧根果 148克</span>
          ...
          <div class="print_wrap">
              <span>已售417件</span>
            <div class="img_buy"><img src="../../../assets/images/search/buy_btn@2x.png" alt=""></div>
          </div>
      </div>
