...
<template>
  <div class="shops-wrapper">
      ...
      <li class="shop-item" v-if="shopList.list">
        ...
        <div class="content">
          ...
          <div class="extra">
            ...
            <span v-else-if="item.price_type==2">金鱼 {{item.price}}</span>
            <span v-else>银鱼 {{item.price}}</span>
            <span
              style="text-decoration:line-through"
              v-if="item.price_type==3"
            >UFV {{item.price_origin}}</span>
            <span
              style="text-decoration:line-through"
              v-else-if="item.price_type==2"
            >金鱼 {{item.price_origin}}</span>
            <span style="text-decoration:line-through" v-else>银鱼 {{item.price_origin}}</span>
          </div>
          <div class="cartcontrol-wrapper">
            <div class="shop_delete" @click="reduce(item)">
              <img src="../../assets/images/shopCar/-@2x.png" alt>
            </div>
            <div class="shop_count">
              <span>{{item.count}}</span>
            </div>
            <div class="shop_add" @click="add(item)">
              <img src="../../assets/images/shopCar/+@2x.png" alt>
            </div>
          </div>
        </div>
    ...
    <div
      class="shopCart_empty"
      v-if="!persons.tid||shopList.gold_fish_total<1&&shopList.ufv_total<1&&shopList.silver_fish_total<1"
    >
      <div class="cart_logo">
    ...
    <div class="shopClose">
      <div class="bill_wrap">
        <span>小计:&nbsp;</span>
        <span>UFV&nbsp;{{shopList.ufv_total}}</span>
        &nbsp;
        <span>金鱼&nbsp;{{shopList.gold_fish_total}}</span>&nbsp;
        <span>银鱼&nbsp;{{shopList.silver_fish_total}}</span>
      </div>
      <div class="shop_bar">
        <img
          @click="removeShopCart(shopList)"
          src="../../assets/images/shopCar/clearbtn@2x.png"
          alt
        >
